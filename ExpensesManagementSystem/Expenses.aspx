<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="ExpensesManagementSystem.Expenses" %>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-12 my-2">
                                    <label class="col-form-label">Expense Description <span class="text-danger">*</span> </label>
                                    <asp:TextBox ID="descriptionTxt" CssClass="form-control" placeholder="Description of Income" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 my-2">
                                    <label class="col-form-label">Expense Date <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <asp:DropDownList ID="categoryDDL" AppendDataBoundItems="true" CssClass="form-control" runat="server">
